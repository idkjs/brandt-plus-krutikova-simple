...
function useMusicPlayer(param) {
  var match = React.useContext(MusicPlayer.musicPlayerContext);
  var dispatch = match[1];
  var state = match[0];
  var playing = state.playing;
  var trackList = state.tracks;
  var currentTrackName = playing ? Caml_array.get(state.tracks, playing._0).name : "Please choose a track to play";
