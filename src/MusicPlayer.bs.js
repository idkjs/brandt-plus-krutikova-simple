...
import BensoundSummerMp3 from "./bensound-summer.mp3";
import BensoundUkuleleMp3 from "./bensound-ukulele.mp3";
import BensoundCreativemindsMp3 from "./bensound-creativeminds.mp3";

var summer = BensoundSummerMp3;

var ukulele = BensoundUkuleleMp3;

var creativeminds = BensoundCreativemindsMp3;
...
function withPlayTrack(state, index) {
  return {
          ...
          audioPlayer: new Audio(Caml_array.get(state.tracks, index).file)
        };
}
